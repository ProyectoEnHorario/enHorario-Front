...
class EstablishmentDetailScreen extends StatelessWidget {
  ...
  static const int _maxTurnos = 50;

  double get _afluenciaValue {
    if (afluenciaStat == null) return 0.0;
    final raw = afluenciaStat!.totalTurnos / _maxTurnos;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          AfluenciaIndicator(value: _afluenciaValue),
